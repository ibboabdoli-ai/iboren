        ...
        <div className="luxe-container relative grid gap-10 lg:grid-cols-[.86fr_1.14fr] lg:items-start">
          <div>
            ...
            <div className="price-info-card iboren-card-glass iboren-card-glass-hover mt-8 rounded-2xl border p-5 text-sm leading-7">
              <p className="iboren-text-muted-dark flex gap-3"><Info className="iboren-gold-accent mt-1 h-5 w-5 shrink-0" /> The calculator gives a detailed price estimate with RUT information. After your request, Iboren confirms the final price, time and any add-ons.</p>
            </div>
