...
import CleanerAvailabilityForm from "../../cleaner/CleanerAvailabilityForm";
import CleanerJobsList from "../../cleaner/CleanerJobsList";
...
export default function EnglishCleanerPage() {
  ...
  if (!hasAccess) {
    return (
      <main className="min-h-screen bg-cream py-16 text-ink">
        <section className="luxe-container max-w-2xl rounded-[2rem] bg-porcelain p-8 shadow-soft">
          <Link href="/en/profile" className="mb-8 inline-flex items-center gap-2 text-sm font-bold text-burgundy"><ArrowLeft size={17} /> Back to profile</Link>
