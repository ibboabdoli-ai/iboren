...
const cityContent: Record<string, PageContent> = {
  "cleaning-sodertalje": {
    ...
    description: "Cleaning in Södertälje with a clear price indication for home cleaning, move-out cleaning, office cleaning and window cleaning, including RUT information for eligible private services.",
