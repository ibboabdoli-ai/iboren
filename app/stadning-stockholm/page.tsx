...
export const metadata: Metadata = {
  ...
  description: "Städning i Stockholm med tydlig prisindikation. Skicka en förfrågan för hemstädning, flyttstädning, kontorsstädning eller fönsterputs med information om RUT-avdrag.",
  ...
  openGraph: {
    title: "Städning i Stockholm – Hemstädning, flyttstädning & kontor | Iboren",
    description: "Städning i Stockholm med tydlig prisindikation för hemstädning, flyttstädning, kontorsstädning och fönsterputs.",
      ...
      <section className="iboren-page-dark py-16">
        <div className="luxe-container max-w-4xl">
          <div className="iboren-card-glass mb-12 rounded-[2rem] p-7">
            <p className="iboren-gold-accent text-[11px] font-bold uppercase tracking-[.38em]">Pris och RUT i Stockholm</p>
            <h2 className="display mt-3 text-4xl font-bold text-porcelain">Tydligt underlag före bekräftelse.</h2>
