  ...
  return (
    <section id="top" className="relative grid min-h-screen place-items-center overflow-hidden px-5 pt-28 text-center lg:justify-items-start lg:px-[8vw] lg:text-left">
      ...
      <div className="relative z-10 mx-auto max-w-6xl lg:mx-0 lg:pr-16">
        ...
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row md:mt-10 lg:items-start lg:justify-start"><Link href="/priser#pris-kalkylator" className="btn-primary">Få pris direkt <ArrowUpRight size={17} /></Link></div>
