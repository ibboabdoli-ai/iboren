  ...
  return (
    <section id="top" className="relative grid min-h-screen place-items-center overflow-hidden px-5 pt-28 text-center">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="mt-7 flex flex-wrap items-center justify-center gap-2 md:mt-8">
        ...
        {activeTrustBadge && (
          <div
            ...
            aria-live="polite"
            className="mx-auto mt-3 max-w-2xl rounded-2xl border border-gold/25 bg-night/85 px-4 py-3 text-left text-xs leading-5 text-porcelain/85 shadow-[0_18px_55px_rgba(0,0,0,.28)] backdrop-blur-xl md:px-5 md:py-4 md:text-sm md:leading-6"
          >
            <span className="font-bold text-gold">{activeTrustBadge.label}:</span>{" "}
            {activeTrustBadge.explanation}
          </div>
        )}
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row md:mt-10"><Link href="/priser#pris-kalkylator" className="btn-primary">Få pris direkt <ArrowUpRight size={17} /></Link></div>
        <p className="mx-auto mt-5 max-w-xl text-sm font-bold leading-6 text-porcelain/75">Beräkna pris först. Du kan gå vidare till en ej bindande bokningsförfrågan när allt ser rätt ut.</p>
