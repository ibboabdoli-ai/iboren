        ...
        <div className="luxe-container relative grid gap-10 lg:grid-cols-[.86fr_1.14fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 rounded-2xl border border-burgundy/10 bg-porcelain p-5 text-sm leading-7 text-ink/75">
              <p className="flex gap-3"><Info className="mt-1 h-5 w-5 shrink-0 text-burgundy" /> Kalkylen visar en prisindikation med tydlig RUT-beräkning. Alla priser för privatpersoner visas inklusive moms. Efter din förfrågan bekräftar Iboren slutligt pris, tid och eventuella tillval.</p>
            </div>
