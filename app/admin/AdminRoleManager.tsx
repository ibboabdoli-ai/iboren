    ...
    <section className="mt-6 rounded-[2rem] bg-porcelain p-5 shadow-soft md:p-7">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl leading-7 text-ink/65">Add or edit cleaners, supervisors and admins without using Supabase SQL. Customers do not need a manual role.</p>
        </div>
