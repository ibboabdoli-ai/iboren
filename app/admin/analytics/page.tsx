...
import { ArrowLeft, BarChart3, CalendarDays, Loader2, MousePointerClick, RefreshCw } from "lucide-react";
import { createClient } from "@supabase/supabase-js";

type Analytics = { totals: { pageViews: number; quoteClicks: number; bookingClicks: number }; pages: { path: string; count: number }[] };
