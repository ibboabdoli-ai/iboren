    ...
    <section className="bg-cream py-16" id="rut-avdrag">
      <div className="luxe-container grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-ink/72">RUT-avdrag kan tillämpas enligt Skatteverkets regler när villkoren är uppfyllda. Därför visar Iboren pris före RUT och en prisindikation efter RUT i prisberäknaren.</p>
        </div>
        ...
        <div className="rounded-[2rem] border border-burgundy/10 bg-porcelain p-6 shadow-soft md:p-8">
          <div className="mb-6 flex items-start gap-3 rounded-2xl bg-cream p-4 text-sm leading-7 text-ink/72">
            ...
            <p>RUT är en skattereduktion på arbetskostnaden. Avdraget kan tillämpas när Skatteverkets villkor är uppfyllda och slutlig hantering sker i samband med fakturering.</p>
          </div>
