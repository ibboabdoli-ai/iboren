...
function estimatePrice(input: EstimateInput): Estimate {
  ...
  if (input.service === "Home cleaning") {
    ...
    return { title: "Estimated price for home cleaning", beforeRut, afterRut: beforeRut * rutFactor, hours, addOnsBeforeRut, riskLevel: riskLevel(input), factors, note: "Price indication based on size, bathrooms, rooms, condition, access, frequency and add-ons. Final price is confirmed before the request becomes binding." };
  }
