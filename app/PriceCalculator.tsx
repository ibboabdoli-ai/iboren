...
function englishNote(note: string) {
  if (note.includes("hemstädning")) return "Estimate based on size, bathrooms, rooms, condition, access, frequency and add-ons. Final price is confirmed before the request becomes binding.";
