...
export const metadata: Metadata = {
  ...
  description: "Boka fönsterputs med Iboren. Skapa en tydlig bokningsförfrågan för fönsterputs hemma eller på arbetsplatsen."
};
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="luxe-container relative grid gap-10 md:grid-cols-[.95fr_1.05fr] md:items-center">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-ink/70 md:text-xl">Skapa en tydlig förfrågan för fönsterputs. Iboren samlar rätt information om plats, omfattning, datum och eventuella önskemål innan bokningen bekräftas.</p>
